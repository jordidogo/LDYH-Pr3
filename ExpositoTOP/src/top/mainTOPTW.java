...
/**
 * 
 * @class principal TOPTW
 * @brief Clase de programa principal
 * 
 * @detalils Esta clase carga los gráficos de distancia contenidos en los archivos txt y calcula la ruta óptima.
 * 
 */
